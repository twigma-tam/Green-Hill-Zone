  ...
  return (
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <div className="mx-auto max-w-xl px-6 py-8">
        ...
        <h1 className="mb-2 text-2xl font-bold text-[var(--text)]">Accounts receivable aging</h1>
        <p className="mb-6 text-sm text-[var(--text-secondary)]">Snapshot only — not wired to a live ledger.</p>

        <div className="flex flex-col gap-3">
          {buckets.map((b) => (
            <div
              key={b.label}
              className="flex items-center justify-between rounded-lg border border-[var(--border)] bg-[var(--surface)] p-4 text-[15px]"
